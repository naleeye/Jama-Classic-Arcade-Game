...
app.gameOverImg = function() {
    ...
    switch(r){
        case 0:
            $(imageGameOver).attr('src', 'images/gameover2.png');
            break;
        case 1:
            $(imageGameOver).attr('src', 'images/gameover2.png');
            break;
...
Character.prototype.getSpeed = function() {
    return Math.floor(Math.random() * (app.maxSpeed - 100 + 3)) + 100;
};
...
var Enemy = function() {
    ...
    this.sprite = 'images/enemy-bowser.png';
};
